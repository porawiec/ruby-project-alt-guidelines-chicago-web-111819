...
jesp1r = Review.create(rating: 9, tasting_id: jesp1.id)
jdop1r = Review.create(rating: 4, tasting_id: jdop1.id)
jesp2r = Review.create(rating: 7, tasting_id: jesp2.id)
aesp1r = Review.create(rating: 5, tasting_id: aesp1.id)
adop1r = Review.create(rating: 2, tasting_id: adop1.id)